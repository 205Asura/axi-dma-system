...
################################################################
# This is a generated script based on design: AXI_DMA_system
#
...
# source AXI_DMA_system_script.tcl
...
set design_name AXI_DMA_system
...
proc create_root_design { parentCell } {
  ...
  set pixel_clk_0 [ create_bd_port -dir O -type clk pixel_clk_0 ]
  set serdes_clk_0 [ create_bd_port -dir O -type clk serdes_clk_0 ]
  set locked_0 [ create_bd_port -dir O locked_0 ]
  set vid_io_out_reset_0 [ create_bd_port -dir I -type rst vid_io_out_reset_0 ]
  set_property -dict [ list \
...
\
  ...
  # Create instance: axi_dma_shim_0, and set properties
  set block_name axi_dma_shim
  set block_cell_name axi_dma_shim_0
  if { [catch {set axi_dma_shim_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_dma_shim_0 eq "" } {
  ...
  [get_bd_pins rst_ps7_0_142M/slowest_sync_clk] \
  ...
  connect_bd_net -net rst_ps7_0_142M_peripheral_aresetn  [get_bd_pins rst_ps7_0_142M/peripheral_aresetn] \
  ...
  connect_bd_net -net vid_io_out_reset_0_1  [get_bd_ports vid_io_out_reset_0] \
  ...
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_shim_0/m_axi_lite] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
